...
def obter_caminho_config():
  ...
  # Path.home() descobre automaticamente o usuário atual (ex: C:\Users\NomeDoUsuario)
  pasta_documentos = Path.home() / "Documents" / "RemessaDocumentos"

  # Garante que a pasta existe (se não existir, o Python cria)
...
def carregar_ou_configurar_caminhos():
  ...
  caminhos = {
      ...
      "DIR_PDF_PEDIDO": selecionar_pasta(
          "Selecione a pasta de PDF dos Pedidos"
      ),
      "DIR_PDF_BOLETO": selecionar_pasta(
          "Selecione a pasta onde salvar os Boletos gerados"
      ),
  }

  # Salva o JSON na pasta Documentos
