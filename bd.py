...
def consultar_pedido(numero_input):
  ...
  try:
    ...
    # Prepara os documentos para cada etapa com limpeza correta de zeros
    doc_pedido = num_formatado  # 1º: Pedido com 00 (ex: 0032231)
    nfe_com_zeros = formatar_7_digitos(nfe_encontrada) if nfe_encontrada else ""  # 2º: NFe com 00 (ex: 0078975)
    rps_com_zeros = formatar_7_digitos(rps_encontrado) if rps_encontrado else ""  # 3º: NFS/RPS com 00 (ex: 0013265)
    ...
    )  # 4º: Manual NFE/NFS limpo (ex: 78975/18836)
